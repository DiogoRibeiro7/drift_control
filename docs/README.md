...
- `tutorials/README.md`: scenario-driven tutorials and notebooks
...
- `operations/migration-guide.md`: upgrade and rollout patterns for changing detectors/integrations
